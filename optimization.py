        ...
        for t in range(args.epochs):
            ...
            if best_hsstss < check_hsstss:
                ...
                PATH = (
                    crr_dir
                    + "results/trained/"
                    + f"{args.models}_{year}{month:02d}_train2011to2013_test2024_{args.filetag}_{iter}.pth"
                )
                # save model
                torch.save(
                    {
                ...
                pred_path = (
                    crr_dir
                    + "results/prediction/"
                    + f"{args.models}_{year}{month:02d}_train2011to2013_test2024_{args.filetag}_{iter}.npy"
                )
